...
(function(window) {
  ...
  const AccessGuard = {
    ...
    getDefaultHome() {
      ...
      // EVERYONE else → V2 Admin UI (app.html loads admin-v2.html).
      // admin-v2 filters visible features by module_access, so each role
      // sees only what they're allowed. Single consistent UI for whole team.
      return '/app.html#v2';
    },
