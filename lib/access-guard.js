...
(function(window) {
  ...
  const ROLE_DEFAULTS = {
    ...
    'designer': ['admin-v2', 'designer-uploads', 'campaign-status', 'launch-campaign', 'dashboard'],
    'design': ['admin-v2', 'designer-uploads', 'campaign-status', 'launch-campaign', 'dashboard'],
